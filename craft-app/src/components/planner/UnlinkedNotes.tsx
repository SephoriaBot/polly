...
export default function UnlinkedNotes({
  ...
  if (items.length === 0) {
    return (
        ...
        <EmptyState image={emptyPlanner} message="No unlinked notes yet." />
                ...
                {bringUpOpen.map((item) => (
                  <div key={item.id} className={notesStyles.row}>
                    <button
                      ...
                      type="button"
                    >
                      <Icon name="icon-circle" size={18} /> Covered
                    </button>
                  ...
                  <div key={item.id} className={notesStyles.coveredBlock}>
                    <div className={notesStyles.row}>
                      <button
                        ...
                        type="button"
                      >
                        <Icon name="clipboard-check" size={18} className={notesStyles.coveredIcon} /> Covered
                      </button>
              ...
              <section className={`${notesStyles.section} ${notesStyles.homeworkSection}`}>
                ...
                {homework.map((item) => (
                  <div key={item.id} className={notesStyles.row}>
                    ...
                    >
                      {item.status === 'done' ? (
                        <><Icon name="clipboard-check" size={18} className={notesStyles.coveredIcon} /> Done</>
                      ) : (
                        <><Icon name="icon-circle" size={18} /> Mark done</>
                      )}
                    </button>
                    <span
