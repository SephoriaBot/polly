    ...
    <div style={styles.page}>
      ...
      {choices.map((c) => (
        <div key={c.id} style={styles.chip}>
          ...
          <button style={styles.removeBtn} onClick={() => removeChoice(c.id)}><Icon name="icon-trash2" size={24} /></button>
        </div>
      ))}
    ...
    <div style={styles.page}>
      ...
      {choice.outcomes.map((o) => (
        <div key={o.id} style={styles.outcomeRow}>
          ...
          <button style={styles.removeBtn} onClick={() => removeOutcome(o.id)}><Icon name="icon-trash2" size={24} /></button>
        </div>
      ))}
